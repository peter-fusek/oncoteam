...
def _create_scheduler():
    ...
    scheduler.add_job(
        run_lab_sync, IntervalTrigger(hours=6), id="lab_sync",
        next_run_time=now + timedelta(minutes=3),
        misfire_grace_time=21600, coalesce=True,
    )
    ...
    scheduler.add_job(
        run_weight_extraction, CronTrigger(hour=9, minute=0), id="weight_extraction",
    ...
    scheduler.add_job(
        ...
        misfire_grace_time=86400 * 2, coalesce=True,
    )
    ...
    scheduler.add_job(
        ...
        misfire_grace_time=86400 * 7, coalesce=True,
    )
    ...
    scheduler.add_job(
        ...
        misfire_grace_time=86400 * 14, coalesce=True,
    )
    ...
    scheduler.add_job(
        run_medication_adherence_check, CronTrigger(hour=20, minute=0),
