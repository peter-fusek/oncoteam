...
_AGENTS: list[AgentConfig] = [
    ...
    AgentConfig(
        ...
        schedule_display=L("každých 14 minút", "every 14 minutes"),
        category=AgentCategory.SYSTEM,
        schedule_type=ScheduleType.INTERVAL,
        schedule_params={"minutes": 14},
    ...
    AgentConfig(
        ...
        schedule_display=L("nedeľa 02:00 UTC (03:00 CET)", "Sunday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.SYSTEM,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "sun", "hour": 2, "minute": 0},
    ...
    AgentConfig(
        ...
        schedule_display=L("nedeľa 02:30 UTC (03:30 CET)", "Sunday 02:30 UTC (03:30 CET)"),
        category=AgentCategory.SYSTEM,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "sun", "hour": 2, "minute": 30},
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok 02:00 UTC (03:00 CET)", "Monday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "mon", "hour": 2, "minute": 0},
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("utorok 02:00 UTC (03:00 CET)", "Tuesday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "tue", "hour": 2, "minute": 0},
        misfire_grace_time=43200,
        cooldown_hours=5,
        whatsapp_enabled=True,
        assigned_tool="analyze_labs",
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("streda 02:15 UTC (03:15 CET)", "Wednesday 02:15 UTC (03:15 CET)"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "wed", "hour": 2, "minute": 15},
        cooldown_hours=48,
        assigned_tool="search_documents",
        prompt_template="""\
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("streda 02:30 UTC (03:30 CET)", "Wednesday 02:30 UTC (03:30 CET)"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "wed", "hour": 2, "minute": 30},
        cooldown_hours=48,
        assigned_tool="search_documents",
        prompt_template="""\
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("sobota 02:00 UTC (03:00 CET)", "Saturday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.RESEARCH,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "sat", "hour": 2, "minute": 0},
        cooldown_hours=48,
        max_turns=12,
    ...
    AgentConfig(
        ...
        schedule_display=L("sobota 02:30 UTC (03:30 CET)", "Saturday 02:30 UTC (03:30 CET)"),
        category=AgentCategory.RESEARCH,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "sat", "hour": 2, "minute": 30},
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("štvrtok 02:00 UTC (03:00 CET)", "Thursday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.CLINICAL,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "thu", "hour": 2, "minute": 0},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=8,
        assigned_tool="search_documents",
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok 02:30 UTC (03:30 CET)", "Monday 02:30 UTC (03:30 CET)"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "mon", "hour": 2, "minute": 30},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=12,
        whatsapp_enabled=True,
    ...
    AgentConfig(
        ...
        schedule_display=L("piatok 02:30 UTC (03:30 CET)", "Friday 02:30 UTC (03:30 CET)"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "fri", "hour": 2, "minute": 30},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=10,
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("nedeľa 03:00 UTC (04:00 CET)", "Sunday 03:00 UTC (04:00 CET)"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "sun", "hour": 3, "minute": 0},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=10,
        whatsapp_enabled=True,
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok 02:15 UTC (03:15 CET)", "Monday 02:15 UTC (03:15 CET)"),
        category=AgentCategory.REPORTING,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "mon", "hour": 2, "minute": 15},
        cooldown_hours=0.5,
        max_turns=6,
        whatsapp_enabled=True,
        assigned_tool="search_documents",
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("piatok 02:00 UTC (03:00 CET)", "Friday 02:00 UTC (03:00 CET)"),
        category=AgentCategory.RESEARCH,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "fri", "hour": 2, "minute": 0},
        misfire_grace_time=86400,
        cooldown_hours=48,
        max_turns=8,
        assigned_tool="search_clinical_trials",
...
""",
    ...
    # === Nightly document drain (Sprint 92 cost reduction) ===
    AgentConfig(
        id="document_pipeline_drain",
        name=L("Nočné spracovanie dokumentov", "Nightly document drain"),
        description=L(
            "Spracuje dokumenty nahraté počas dňa — beží raz denne v CEE noci",
            "Processes docs queued during the day — runs once nightly in the CEE window",
        ),
        schedule_display=L("denne 02:00 UTC (03:00 CET)", "daily 02:00 UTC (03:00 CET)"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        ...
        assigned_tool="view_document",
        prompt_template=(
            "[Drain — reads pending_docs_queue agent_state and calls run_document_pipeline "
            "for each queued doc. No LLM prompt; orchestration only.]"
        ),
    ),
]
