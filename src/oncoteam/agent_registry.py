...
_AGENTS: list[AgentConfig] = [
    ...
    AgentConfig(
        ...
        schedule_display=L("denne 06:00 UTC", "daily 06:00 UTC"),
        category=AgentCategory.SYSTEM,
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 6, "minute": 0},
    ...
    AgentConfig(
        ...
        schedule_display=L("nedeľa 08:00", "Sunday 08:00"),
        category=AgentCategory.SYSTEM,
        model="light",
        schedule_type=ScheduleType.CRON,
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("každých 12h", "every 12 hours"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.INTERVAL,
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok + štvrtok 08:00", "Monday + Thursday 08:00"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 8, "minute": 0, "day_of_week": "mon,thu"},
        cooldown_hours=48,
        assigned_tool="search_documents",
        prompt_template="""\
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("streda + sobota 09:00", "Wednesday + Saturday 09:00"),
        category=AgentCategory.DATA_PIPELINE,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 9, "minute": 0, "day_of_week": "wed,sat"},
        cooldown_hours=48,
        assigned_tool="search_documents",
        prompt_template="""\
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("každé 3 dni 09:00", "every 3 days 09:00"),
    ...
    AgentConfig(
        ...
        schedule_display=L("denne 07:45", "daily 07:45"),
        category=AgentCategory.RESEARCH,
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 7, "minute": 45},
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("streda 11:30", "Wednesday 11:30"),
        category=AgentCategory.CLINICAL,
        model="light",
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "wed", "hour": 11, "minute": 30},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=8,
        assigned_tool="search_documents",
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok 05:00", "Monday 05:00"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
        schedule_params={"day_of_week": "mon", "hour": 5},
        misfire_grace_time=86400 * 2,
        cooldown_hours=0.5,
        max_turns=12,
        whatsapp_enabled=True,
    ...
    AgentConfig(
        ...
        schedule_display=L("piatok 14:00", "Friday 14:00"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("nedeľa 18:00", "Sunday 18:00"),
        category=AgentCategory.REPORTING,
        schedule_type=ScheduleType.CRON,
