...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("každé 3 dni", "every 3 days"),
        category=AgentCategory.RESEARCH,
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 7, "minute": 30, "day": "*/3"},
        cooldown_hours=48,
        max_turns=12,
    ...
    AgentConfig(
        ...
        schedule_display=L("denne 07:00", "daily 07:00"),
        category=AgentCategory.RESEARCH,
        schedule_type=ScheduleType.CRON,
        schedule_params={"hour": 7, "minute": 0},
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("streda 10:00", "Wednesday 10:00"),
        category=AgentCategory.CLINICAL,
        model="light",
        schedule_type=ScheduleType.CRON,
...
""",
    ...
    AgentConfig(
        ...
        schedule_display=L("pondelok 06:00", "Monday 06:00"),
