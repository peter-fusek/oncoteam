const translations = {
  en: {
    ...
    "features.observatory.title": "Agent Observatory",
    "features.observatory.text": "Watch all 17 autonomous agents work in real time. See thinking steps, tool calls with full I/O, costs, and run history. Full transparency into every AI decision.",
    "features.prompts.title": "Prompt Explorer",
    "features.prompts.text": "See every prompt sent to AI, every tool output returned, and the complete message history. Search and filter across all agent runs. No black boxes.",
    "features.family.title": "Family Updates",
    "features.family.text": "Generate easy-to-understand treatment summaries for family members. Available in Slovak and English, shareable via WhatsApp or print.",
    ...
    "stats.agents": "Autonomous Agents",
    "stats.tools": "MCP Tools",
    "stats.countries": "EU Countries Monitored",
  ...
  sk: {
    ...
    "features.observatory.title": "Observat\u00f3rium agentov",
    "features.observatory.text": "Sledujte v\u0161etk\u00fdch 17 auton\u00f3mnych agentov v re\u00e1lnom \u010dase. Vidzte kroky myslenia, volania n\u00e1strojov s I/O, n\u00e1klady a hist\u00f3riu behov. \u00dapln\u00e1 transparentnos\u0165 ka\u017ed\u00e9ho rozhodnutia AI.",
    "features.prompts.title": "Prieskumn\u00edk promptov",
    "features.prompts.text": "Pozrite si ka\u017ed\u00fd prompt odoslan\u00fd AI, ka\u017ed\u00fd v\u00fdstup n\u00e1stroja a kompletn\u00fa hist\u00f3riu spr\u00e1v. Vyh\u013ead\u00e1vajte a filtrujte v\u0161etky behy agentov. \u017diadne \u010dierne skrinky.",
    "features.family.title": "Spr\u00e1vy pre rodinu",
    "features.family.text": "Generujte zrozumite\u013en\u00e9 s\u00fahrny lie\u010dby pre \u010dlenov rodiny. Dostupn\u00e9 v sloven\u010dine a angli\u010dtine, zdie\u013eate\u013en\u00e9 cez WhatsApp alebo tla\u010d.",
    ...
    "stats.agents": "Auton\u00f3mnych agentov",
    "stats.tools": "MCP n\u00e1strojov",
    "stats.countries": "Monitorovan\u00fdch kraj\u00edn E\u00da",
    "stats.tests": "Automatick\u00fdch testov",
