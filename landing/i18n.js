...
const translations = {
  en: {
    ...
    "pc.title": "Same information. From your closet to your phone.",
    "pc.subtitle": "40+ years of Slovak medical paperwork. One WhatsApp message. A structured answer in seconds — including handwritten notes from 1982.",
    "pc.beat1": "Pile in hand — the chaos every family starts with.",
    "pc.beat2": "Phone in hand — one word, one answer.",
    "pc.beat3": "We read everything — including a handwritten note from 1982.",
    "pc.chat.status": "online · WhatsApp",
    "pc.chat.reply1": "&#x1F4CA; <strong>Labs (Mar 19):</strong><br>ANC 1,150 &darr;, PLT 269k, HGB 118 &uarr;<br>CEA 733 &darr;62%, CA19-9 22.3k &darr;68%<br><em>ANC below threshold — discuss before C3.</em>",
    "pc.chat.q2": "questions for oncologist",
    "pc.chat.reply2": "&#x1F4DD; <strong>For your next visit:</strong><br>1. ANC hold — dose reduction for C3?<br>2. CEA response excellent — imaging timeline?<br>3. Iron supplementation given HGB trend?",
    "pc.footnote": "Real desk. Real documents. The dashboard layer is powered by Oncofiles; the WhatsApp + reasoning layer is Oncoteam.",
    ...
    "faq.a2_detailed": "No. Oncoteam uses the <strong>Anthropic API</strong> (not consumer Claude.ai). Anthropic\u2019s <a href=\"https://www.anthropic.com/legal/commercial-terms\" target=\"_blank\" rel=\"noopener\">Commercial Terms</a> explicitly state: <em>\u201cAnthropic may not train models on Customer Content from Services.\u201d</em> This is fundamentally different from consumer ChatGPT, which trains on your data by default. Your medical documents are processed in real-time, never stored for training, and auto-deleted within 7 days. Voice notes are transcribed by <strong>OpenAI Whisper-1</strong> via API (same no-training guarantee); audio is ephemeral.",
    "faq.q_models": "Which AI models process my data?",
    "faq.a_models": "Oncoteam uses two Anthropic models plus one OpenAI model, all via commercial APIs (zero training on your data):<br><br><strong>Claude Haiku 4.5</strong> \u2014 lightweight model for fast data tasks: document scanning, lab value extraction, medication parsing, WhatsApp replies. Cost: ~$0.80/million tokens.<br><br><strong>Claude Sonnet 4.6</strong> \u2014 advanced reasoning model for: clinical trial analysis, treatment briefings, dose extraction from handwritten notes, family-friendly summaries. Cost: ~$3/million tokens.<br><br>24 autonomous agents use these two Anthropic models: 13 Sonnet agents, 11 Haiku agents.<br><br><strong>OpenAI Whisper-1</strong> \u2014 voice message transcription only. Audio is ephemeral (not stored), and OpenAI does not train on API inputs per their commercial terms.<br><br>All three run under SOC 2 Type II certified APIs (<a href=\"https://trust.anthropic.com/\" target=\"_blank\" rel=\"noopener\">Anthropic</a>, OpenAI). No consumer-grade models (ChatGPT Free, Claude Free) are ever used.",
    "faq.q_retention": "How long does Anthropic keep my data?",
    "faq.a_retention": "API inputs and outputs are <strong>automatically deleted within 7 days</strong> — Anthropic reduced this from 30 days on <a href=\"https://platform.claude.com/docs/en/build-with-claude/api-and-data-retention\" target=\"_blank\" rel=\"noopener\">September 15, 2025</a>. This retention is solely for safety monitoring (abuse prevention), not training. Anthropic also offers Zero Data Retention (ZDR) for enterprise / team API customers; Oncoteam currently runs on standard API, which is already sufficient for the no-training and 7-day guarantees. Details: <a href=\"https://privacy.claude.com/en/articles/7996866-how-long-do-you-store-my-organization-s-data\" target=\"_blank\" rel=\"noopener\">Anthropic Privacy Center</a>. For comparison, consumer ChatGPT retains data indefinitely unless you manually delete it.",
    ...
    "faq.a_vs_chatgpt": "<strong>Radically different.</strong> When you paste lab results into consumer ChatGPT, your data is used for model training by default, retained indefinitely, and has no patient isolation. Oncoteam uses the commercial Anthropic API where training on your data is contractually prohibited, retention is 7 days (for abuse-prevention review only), each patient has isolated access tokens, and the entire system is open-source for verification. It\u2019s the difference between shouting your diagnosis in a crowd vs. talking to your doctor in a private room.",
    ...
    "footer.guides": "Guides for patient advocates:",
    "footer.guide1": "Managing medical documents",
    "footer.guide2": "Before the oncology visit",
    "footer.guide3": "Molecular profile explained",
    "footer.legal": "Legal notice · Not a medical device",
  ...
  sk: {
    ...
    "hero.phone.status": "online",
    "pc.title": "Tie ist\u00e9 inform\u00e1cie. Zo skrine do telef\u00f3nu.",
    "pc.subtitle": "40+ rokov slovenskej zdravotnej dokument\u00e1cie. Jedna WhatsApp spr\u00e1va. \u0160trukt\u00farovan\u00e1 odpove\u010f za sekundy \u2014 vr\u00e1tane ru\u010dne p\u00edsan\u00fdch pozn\u00e1mok z roku 1982.",
    "pc.beat1": "Papiere v ruke \u2014 chaos, s ktor\u00fdm za\u010d\u00edna ka\u017ed\u00e1 rodina.",
    "pc.beat2": "Telef\u00f3n v ruke \u2014 jedno slovo, jedna odpove\u010f.",
    "pc.beat3": "\u010c\u00edtame v\u0161etko \u2014 aj ru\u010dne p\u00edsan\u00fa pozn\u00e1mku z roku 1982.",
    "pc.chat.status": "online \u00b7 WhatsApp",
    "pc.chat.reply1": "&#x1F4CA; <strong>Lab\u00e1ky (19. 3.):</strong><br>ANC 1 150 &darr;, PLT 269k, HGB 118 &uarr;<br>CEA 733 &darr;62%, CA19-9 22,3k &darr;68%<br><em>ANC pod prahom \u2014 rie\u0161i\u0165 pred C3.</em>",
    "pc.chat.q2": "ot\u00e1zky pre onkol\u00f3ga",
    "pc.chat.reply2": "&#x1F4DD; <strong>Na \u010fal\u0161iu n\u00e1v\u0161tevu:</strong><br>1. ANC hold \u2014 redukcia d\u00e1vky pre C3?<br>2. CEA odpove\u010f v\u00fdborn\u00e1 \u2014 term\u00edny zobrazovacieho vy\u0161etrenia?<br>3. \u017delezo vzh\u013eadom na trend HGB?",
    "pc.footnote": "Re\u00e1lny st\u00f4l. Re\u00e1lne dokumenty. D\u00e1tov\u00e1 vrstva je Oncofiles; vrstva WhatsAppu + uva\u017eovania je Oncoteam.",
    ...
    "uc.1.title": "\u010co hovorili posledn\u00e9 lab\u00e1ky?",
    ...
    "faq.a2_detailed": "Nie. Oncoteam pou\u017e\u00edva <strong>Anthropic API</strong> (nie spotrebite\u013esk\u00fd Claude.ai). <a href=\"https://www.anthropic.com/legal/commercial-terms\" target=\"_blank\" rel=\"noopener\">Obchodn\u00e9 podmienky Anthropic</a> expl\u00edcitne uv\u00e1dzaj\u00fa: <em>\u201eAnthropic may not train models on Customer Content from Services.\u201c</em> To je z\u00e1sadn\u00fd rozdiel oproti spotrebite\u013esk\u00e9mu ChatGPT, ktor\u00fd tr\u00e9nuje na va\u0161ich d\u00e1tach \u0161tandardne. Va\u0161e medic\u00ednske dokumenty sa spracuj\u00fa v re\u00e1lnom \u010dase, nikdy sa neukladaj\u00fa na tr\u00e9ning a automaticky sa zma\u017e\u00fa do 7 dn\u00ed. Hlasov\u00e9 spr\u00e1vy transkribuje <strong>OpenAI Whisper-1</strong> cez API (rovnak\u00e1 garancia bez tr\u00e9ningu); audio je efemern\u00e9.",
    "faq.q_models": "Ak\u00e9 AI modely spracov\u00e1vaj\u00fa moje d\u00e1ta?",
    "faq.a_models": "Oncoteam pou\u017e\u00edva dva modely od Anthropic plus jeden od OpenAI, v\u0161etky cez komer\u010dn\u00e9 API (nulov\u00fd tr\u00e9ning na va\u0161ich d\u00e1tach):<br><br><strong>Claude Haiku 4.5</strong> \u2014 \u013eahk\u00fd model pre r\u00fdchle d\u00e1tov\u00e9 \u00falohy: skenovanie dokumentov, extrakcia laborat\u00f3rnych hodn\u00f4t, parsovanie liekov, WhatsApp odpovede. Cena: ~$0,80/mili\u00f3n tokenov.<br><br><strong>Claude Sonnet 4.6</strong> \u2014 pokro\u010dil\u00fd model pre: anal\u00fdzu klinick\u00fdch \u0161t\u00fadi\u00ed, lie\u010debn\u00e9 briefy, extrakciu d\u00e1vok z ru\u010dne p\u00edsan\u00fdch pozn\u00e1mok, zhrnutia pre rodinu. Cena: ~$3/mili\u00f3n tokenov.<br><br>24 auton\u00f3mnych agentov vyu\u017e\u00edva tieto dva Anthropic modely: 13 Sonnet agentov, 11 Haiku agentov.<br><br><strong>OpenAI Whisper-1</strong> \u2014 v\u00fdhradne transkripcia hlasov\u00fdch spr\u00e1v. Audio je efemern\u00e9 (neuklad\u00e1 sa) a OpenAI netr\u00e9nuje na API vstupoch pod\u013ea ich komer\u010dn\u00fdch podmienok.<br><br>V\u0161etky tri be\u017eia pod API s certifik\u00e1ciou SOC 2 Type II (<a href=\"https://trust.anthropic.com/\" target=\"_blank\" rel=\"noopener\">Anthropic</a>, OpenAI). \u017diadne spotrebite\u013esk\u00e9 modely (ChatGPT Free, Claude Free) sa nikdy nepou\u017e\u00edvaj\u00fa.",
    "faq.q_retention": "Ako dlho si Anthropic uchov\u00e1va moje d\u00e1ta?",
    "faq.a_retention": "Vstupy a v\u00fdstupy z API sa <strong>automaticky zma\u017e\u00fa do 7 dn\u00ed</strong> \u2014 Anthropic zn\u00ed\u017eil toto obdobie z 30 dn\u00ed <a href=\"https://platform.claude.com/docs/en/build-with-claude/api-and-data-retention\" target=\"_blank\" rel=\"noopener\">15. septembra 2025</a>. Toto uchov\u00e1vanie sl\u00fa\u017ei v\u00fdhradne na bezpe\u010dnostn\u00fd monitoring (prevencia zneu\u017eitia), nie na tr\u00e9ning. Anthropic tie\u017e pon\u00faka Zero Data Retention (ZDR) pre enterprise a team API z\u00e1kazn\u00edkov; Oncoteam aktu\u00e1lne be\u017e\u00ed na \u0161tandardnom API, ktor\u00e9 u\u017e samo o sebe posta\u010duje na garancie bez tr\u00e9ningu a 7-d\u0148ov\u00fa retenciu. Detaily: <a href=\"https://privacy.claude.com/en/articles/7996866-how-long-do-you-store-my-organization-s-data\" target=\"_blank\" rel=\"noopener\">Anthropic Privacy Center</a>. Pre porovnanie, spotrebite\u013esk\u00fd ChatGPT uchov\u00e1va d\u00e1ta neobmedzene, pokia\u013e ich manu\u00e1lne nezma\u017eete.",
    ...
    "faq.a_vs_chatgpt": "<strong>Z\u00e1sadne.</strong> Ke\u010f vlo\u017e\u00edte laborat\u00f3rne v\u00fdsledky do spotrebite\u013esk\u00e9ho ChatGPT, va\u0161e d\u00e1ta sa \u0161tandardne pou\u017e\u00edvaj\u00fa na tr\u00e9ning modelov, uchov\u00e1vaj\u00fa sa neobmedzene a nemaj\u00fa izol\u00e1ciu pacientov. Oncoteam pou\u017e\u00edva komer\u010dn\u00e9 Anthropic API, kde je tr\u00e9ning na va\u0161ich d\u00e1tach zmluvne zak\u00e1zan\u00fd, uchov\u00e1vanie 7 dn\u00ed (len na bezpe\u010dnostn\u00fa kontrolu), ka\u017ed\u00fd pacient m\u00e1 izolovan\u00e9 pr\u00edstupov\u00e9 tokeny a cel\u00fd syst\u00e9m je open-source na overenie. Je to rozdiel medzi t\u00fdm, \u010di svoju diagn\u00f3zu kri\u010d\u00edte v dave, alebo sa rozpr\u00e1vate s lek\u00e1rom v s\u00fakromnej ordina\u010dii.",
    ...
    "footer.instarea2": ".",
    "footer.guides": "Sprievodcovia pre rodinn\u00fdch advok\u00e1tov:",
    "footer.guide1": "Spr\u00e1va lek\u00e1rskych dokumentov",
    "footer.guide2": "Pred n\u00e1v\u0161tevou onkol\u00f3ga",
    "footer.guide3": "Molekul\u00e1rny profil n\u00e1doru",
    "footer.legal": "Pr\u00e1vne upozornenie \u00b7 Nie je zdravotn\u00edcka pom\u00f4cka",
