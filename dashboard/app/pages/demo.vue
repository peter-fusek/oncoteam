...
const DT = {
  sk: {
    ...
    treatmentStatus: 'Stav liečby', recentLabs: 'Posledné labáky',
    ...
    readyDesc: 'Oncoteam je AI platforma pre onkologické tímy. Sleduje labáky, manažuje klinické štúdie a poskytuje autonómne výskumné briefingy.',
